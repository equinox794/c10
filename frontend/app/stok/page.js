        ...
        return (
            <form onSubmit={(e) => {
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        <label className="block text-sm font-medium text-gray-700">Hammadde Adı</label>
                        <input
                            type="text"
                            name="name"
                            value={formData.name}
                                    ...
                                    .map((stock) => (
                                        <tr key={stock.id} className="hover:bg-slate-700/50">
                                            ...
                                            <td className="p-4 text-slate-300">
                                                {(stock.quantity * stock.price).toLocaleString('tr-TR', { minimumFractionDigits: 2 })}
                                            </td>
                                            <td className="p-4">
                                                <div className="flex gap-2">
                                                    <button
                    ...
                    <div className="bg-slate-800 rounded-lg shadow-xl w-full max-w-4xl">
                        ...
                        <form onSubmit={handleNewSubmit} className="p-6">
                            <div className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="block text-sm font-medium text-slate-200">Ürün Adı</label>
                                        <input
                                            type="text"
                                            name="name"
                                            value={newStock.name || ''}
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-slate-200">Kategori</label>
                                        <select
                                            name="category"
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="block text-sm font-medium text-slate-200">Miktar</label>
                                        <input
                                            type="number"
                                            name="quantity"
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-slate-200">Birim</label>
                                        <select
                                            name="unit"
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="block text-sm font-medium text-slate-200">Fiyat (TL)</label>
                                        <input
                                            type="number"
                                            name="price"
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-slate-200">Min. Miktar</label>
                                        <input
                                            type="number"
                                            name="min_quantity"
