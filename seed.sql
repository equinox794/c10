...
-------------------------------------------------------------------------------
INSERT INTO stock (code, name, quantity, min_quantity, cost, price, unit)
VALUES
  ('ST-001', 'Hammadde A', 100, 10, 5.00, 8.00, 'kg'),
  ('ST-002', 'Gubre X',      50,  5, 10.00, 15.00, 'kg'),
  ('ST-003', 'Hammadde B', 200, 20, 3.00,  5.00, 'kg');
